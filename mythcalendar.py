...
# Copyright (C) 2009 Nick Piper <nick-github@nickpiper.co.uk>
# Copyright (C) 2007-2008 Jan Alonzo <jmalonzo@unpluggable.com>

## You need python-webkit and python-pylirc

## Put the URL to your Google calendar (or some other page)
## into ~/.calendar_url

## You need something like this in your lircrc:
#begin
#     button = Back
#     prog = mythcalendar
#     config = quit
...
## Then edit your MythTV menu (e.g. /usr/share/mythtv/themes/DVR/mainmenu.xml)
#        <button>
#                <type>MENU_UTILITIES_SETUP</type>
#                <text>Calendar</text>
#                <action>EXEC "/var/lib/mythtv/bin/mythcalendar.py"</action>
#        </button>


# This is derived from http://code.google.com/p/pywebkitgtk/source/browse/trunk/demos/tabbed_browser.py
# I'll be taking OUT more tabbed support, and then ADDING
# more lirc based control
...
class WebBrowser(gtk.Window):
    ...
    def __init__(self):
        ...
        url = open(os.path.expanduser("~/.calendar_url")).read().strip()
